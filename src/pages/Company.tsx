...
const Company = () => {
  ...
  return (
    <div className="container flex flex-col items-center justify-center gap-8 mx-auto sectionPadding pb-16">
      ...
      <div>
        <h3 className="w-[400px] text-center text-lg">{data?.overview}</h3>
      ...
      <button
        className="text-center mx-auto text-4xl text-primary"
        title="Add Project"
      ...
      <Button
        className="bg-primary hover:bg-secondary duration-300"
